...
export const VillaCard = ({ villa, className }: VillaCardProps) => {
  return (
    <div className={cn("bg-gray-800 rounded-lg overflow-hidden transition-all duration-300 hover:translate-y-[-8px] hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.3)] group", className)}>
      <div className="relative h-64 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5 text-white translate-y-full group-hover:translate-y-0 transition-transform duration-300">
          ...
          <div className="flex gap-2">
            ...
            <Button asChild size="sm" className="flex-1 bg-villa-terracotta hover:bg-villa-terracotta/90 text-white">
